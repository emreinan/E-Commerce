        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinOrderAmount = table.Column<byte>(type: "tinyint", nullable: false, defaultValue: (byte)0),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CHK_Product_Price", "[Price] > 0");
                    table.CheckConstraint("CHK_Product_StockAmount", "[StockAmount] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressTitle = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpiresAt = table.Column<DateTime>(type: "datetime2", maxLength: 512, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StarCount = table.Column<byte>(type: "tinyint", nullable: false, defaultValue: (byte)1),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CHK_ProductComment_StarCount", "[StarCount] BETWEEN 1 AND 5");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CHK_BasketItem_Quantity", "[Quantity] >= 1");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductNameAtOrderTime = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ProductPriceAtOrderTime = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_AddressTitle",
                table: "Addresses",
                column: "AddressTitle",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Baskets_GuestId_IsActive",
                table: "Baskets",
                columns: new[] { "GuestId", "IsActive" },
                unique: true,
                filter: "[GuestId] IS NOT NULL AND IsActive = 1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Baskets_UserId_IsActive",
                table: "Baskets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductComments_ProductId_UserId",
